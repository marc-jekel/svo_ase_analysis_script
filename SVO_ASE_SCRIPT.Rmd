...
coop_above = mean(res$ASE_pros_m[res$SVO_part>=22.5]  >= 75)
coop_below = mean(res$ASE_pros_m[res$SVO_part>22.5]  <= 25)
coop_above
coop_below
1 - coop_above - coop_below

indiv_above = mean(res$ASE_pros_m[ res$SVO_part<22.5] >= 75)
indiv_below = mean(res$ASE_pros_m[res$SVO_part<22.5] <= 25)
indiv_above
indiv_below
...
coop_above = mean(res_fin$ASE_pros_m[res_fin$SVO_part>=22.5]  >= 75)
coop_below = mean(res_fin$ASE_pros_m[res_fin$SVO_part>=22.5]  <= 25)
coop_above
coop_below
1 - coop_above - coop_below

indiv_above = mean(res_fin$ASE_pros_m[res_fin$SVO_part<22.5] >= 75)
indiv_below = mean(res_fin$ASE_pros_m[res_fin$SVO_part<22.5] <= 25)
indiv_above
indiv_below
1 - indiv_above - indiv_below
