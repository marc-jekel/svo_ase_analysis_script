...
## Correlation between AS, SVO, and choice
...
plot(res$ASE_pros_m,rowMeans(choice_s_1_single_diagn),xlab = "ASE", ylab = "choice pro-social")
plot(res$SVO_part,rowMeans(choice_s_1_single_diagn),xlab = "SVO", ylab = "choice pro-social")
```
...
plot(100*(score_indiv_search/20),rowMeans(choice_s_2_01),xlab = "ASE", ylab = "choice pro-social")
plot(SVO_part,rowMeans(choice_s_2_01),xlab = "SVO", ylab = "choice pro-social")
