...
coop_above = mean(res$ASE_pros_m[res$SVO_part>22.5 &   res$SVO_part<67.5]  > 75)
coop_below = mean(res$ASE_pros_m[res$SVO_part>22.5 &   res$SVO_part<67.5]  < 25)
coop_above
coop_below
1 - coop_above - coop_below

indiv_above = mean(res$ASE_pros_m[res$SVO_part>-22.5 &   res$SVO_part<22.5] > 75)
indiv_below = mean(res$ASE_pros_m[res$SVO_part>-22.5 &   res$SVO_part<22.5] < 25)
indiv_above
indiv_below
...
overlap_search_choice = ifelse(choice_s_1_single_diagn == ASE_pros, 1, 0)
cor.test(res$SVO_part,rowSums(overlap_search_choice),method = "spearman")

###

plot(res$ASE_pros_m,rowMeans(choice_s_1_single_diagn),xlab = "ASE", ylab = "choice pro-social",pch=16,   col = alpha("black", 0.2))

plot(res$SVO_part,rowMeans(choice_s_1_single_diagn),xlab = "SVO", ylab = "choice pro-social",pch=16,   col = alpha("black", 0.2))
...
coop_above = mean(res_fin$ASE_pros_m[res_fin$SVO_part>22.5 &   res_fin$SVO_part<67.5]  > 75)
coop_below = mean(res_fin$ASE_pros_m[res_fin$SVO_part>22.5 &   res_fin$SVO_part<67.5]  < 25)
coop_above
coop_below
1 - coop_above - coop_below

indiv_above = mean(res_fin$ASE_pros_m[res_fin$SVO_part>-22.5 &   res_fin$SVO_part<22.5] > 75)
indiv_below = mean(res_fin$ASE_pros_m[res_fin$SVO_part>-22.5 &   res_fin$SVO_part<22.5] < 25)
indiv_above
indiv_below
1 - indiv_above - indiv_below
...
plot(100*(score_indiv_search/20),rowMeans(choice_s_2_01),xlab = "ASE", ylab = "choice pro-social",pch=16,   col = alpha("black", 0.2))
plot(SVO_part,rowMeans(choice_s_2_01),xlab = "SVO", ylab = "choice pro-social",pch=16,   col = alpha("black", 0.2))

## susa

search_susa = ifelse(search == 2,1,0)

overlap_search_choice = ifelse(choice_s_2_01 == search_susa, 1, 0)
cor.test(SVO_part,rowMeans(overlap_search_choice),method = "spearman")
...
rt = dats_s2_2  %>% dplyr::select(
  contains("Time_search_Page Submit")
    )

order_items = dats_s2_2 %>% dplyr::select(contains("Trial_"))
